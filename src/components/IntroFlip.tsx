      ...
      <Reveal>
        ...
        <div className="h-[640px] sm:h-[480px] lg:h-[420px]">
          <PixelSwap
            ...
            trigger="hover"
            firstContent={
              <div className="flex h-full w-full flex-col justify-center gap-6 bg-zinc-50 p-8 sm:p-12 lg:flex-row lg:items-center lg:gap-12">
            ...
            secondContent={
              <div className="flex h-full w-full flex-col justify-center gap-6 bg-foreground p-8 text-white sm:p-12 lg:flex-row lg:items-center lg:gap-12">
                <div className="flex shrink-0 flex-col items-center gap-3 lg:items-start">
